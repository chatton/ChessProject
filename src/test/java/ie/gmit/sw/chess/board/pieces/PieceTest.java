...
public class PieceTest {
    ...
    public void testWhitePawnGetPossiblePositions(){
        ...
        Pawn pawn = new Pawn(board, new Position(3,3), Colour.WHITE);
        ...
        Pawn enemyPawn = new Pawn(board, new Position(4,2), Colour.BLACK);
        board.setAt(new Position(4,2), enemyPawn);

        possibleMoves = pawn.getPossiblePositions();
        assertEquals(possibleMoves.size(), 2);

        Piece allyKing = new King(board, new Position(2,2), Colour.WHITE);
